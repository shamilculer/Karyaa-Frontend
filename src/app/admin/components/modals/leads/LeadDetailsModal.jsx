                    ...
                    <ScrollArea className="overflow-y-auto max-h-[65vh]">
                        ...
                        <div className="space-y-6 py-4">
                            ...
                            {lead.vendor && (
                                <>
                                    <div className="space-y-4">
                                        <h3 className="!text-base uppercase font-semibold">Vendor Information</h3>

                                        <div className="grid xl:grid-cols-2 gap-4">
                                            <div className="flex items-start gap-3">
                                                <Building2 className="w-4 h-4 mt-1.5 text-muted-foreground" />
                                                <div>
                                                    <p className="text-sm text-muted-foreground">Business Name</p>
                                                    <p className="font-medium">{lead.vendor.businessName}</p>
                                                </div>
                                            </div>

                                            {lead.vendor.ownerName && (
                                                <div className="flex items-start gap-3">
                                                    <Hash className="w-4 h-4 mt-1.5 text-muted-foreground" />
                                                    <div>
                                                        <p className="text-sm text-muted-foreground">Owner Name</p>
                                                        <p className="font-medium">{lead.vendor.ownerName}</p>
                                                    </div>
                                                </div>
                                            )}
