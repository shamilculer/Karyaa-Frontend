    ...
    useEffect(() => {
        if (bundle && open) {
            form.reset({
                ...
                isAddon: bundle.isAddon ?? bundle.isPopular ?? false,
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[800px]">
                <DialogHeader className="border-b pb-4 border-gray-300">
                    <DialogTitle className="uppercase !text-xl">Edit Bundle: {bundle?.name || "Loading..."}</DialogTitle>
                    <DialogDescription>
                        Modify the details, pricing, and configuration for this subscription plan.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <Form {...form}>
                        <form className="space-y-10" onSubmit={e => e.preventDefault()}>
                            <div className="grid gap-6 py-4">
                                ...
                                <h4 className="font-semibold text-lg border-b border-b-gray-400 pb-2">General Details</h4>
                                ...
                                <h4 className="font-semibold text-lg border-b border-gray-300 pb-2">Pricing & Duration</h4>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription className="!text-xs">Extra period added to the subscription.</FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    />
                                ...
                                <h4 className="font-semibold text-lg border-b border-b-gray-300 pb-2">Configuration</h4>
                                ...
                                {/* --- SECTION 4: FEATURES --- */}
                                <h4 className="font-semibold text-lg border-b border-b-gray-300 pb-2 flex justify-between items-center">
                                    Features
                                    <Button
                                        type="button"
                                        onClick={() => append("")}
