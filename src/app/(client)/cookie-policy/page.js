...
export const metadata = {
  title: "Cookie Policy",
  description: "Our cookie usage and tracking practices",
};

const CookiePolicyPage = async () => {
  const result = await getContentByKeyAction("cookie-policy");
          ...
          {result.success && result.data?.content ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">
                Cookie policy content is not available at the moment.
              </p>
