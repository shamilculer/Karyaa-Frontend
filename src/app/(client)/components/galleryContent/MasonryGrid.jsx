// app/components/galleryContent/MasonryGrid.jsx
"use client";
...
// Height variants for more visual interest
const heightClasses = [
    'h-64',   // 256px
    'h-72',   // 288px
    'h-80',   // 320px
    ...
    return (
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-2 max-w-[1600px] w-full">
            {items.map((item, index) => {
                // Assign random-ish heights based on index for variety
                ...
                return (
                    ...
                    >
                        <div className="relative rounded-xl overflow-hidden shadow-lg cursor-pointer group hover:shadow-2xl transition-all duration-300">
