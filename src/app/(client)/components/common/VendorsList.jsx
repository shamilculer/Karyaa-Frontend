...
export const VendorsCard = ({ vendor }) => {
    ...
    const bgColor = getBgColor(vendor.name);
    ...
    return (
        <div className="rounded overflow-hidden">
            <div className="relative group">
                ...
                >
                    {vendor.coverImages.map((img, idx) => (
                        <Image
                            key={idx}
                            fill
                            src={img}
            ...
            <div className="mt-4 px-2 space-y-4">
                ...
                <div className="flex justify-between items-center gap-6">
                    <div className="flex items-center">
                        <Avatar className="w-12 h-12 rounded-full border mr-3 border-gray-300">
                            <AvatarImage
                        ...
                        <div>
                            <h3 className="!text-xl max-md:!text-lg text-[#232536] !font-medium">{vendor.name}</h3>
                            <span className="block text-sm">{vendor.category}</span>
                        </div>
                    </div>
                ...
                {/* Tagline */}
                <p className="line-clamp-2 text-sm">{vendor.tagline}</p>
                ...
                <div className="flex justify-between items-center flex-wrap gap-2">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="ms-2 text-xs md:text-sm font-bold text-gray-900">{vendor.avgRating}/5</p>
                    </div>
