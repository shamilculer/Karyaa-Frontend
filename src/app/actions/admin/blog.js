...
export const createBlogPost = async (formData) => {
    try {
        ...
        return {
            success: false,
            message: response?.message || "Failed to create blog post. Please check the provided data.",
        };
...
export const editBlogPost = async (id, formData) => {
  try {
      ...
      return {
          success: false,
          message: response?.message || "Failed to update blog post. Please check the provided data.",
      };
      ...
      return {
          success: false,
          message: error.message || "An unexpected network or server error occurred while updating the post.",
      };
  }
};
...
      return {
        success: false,
        message: error?.message || "Unexpected server error while deleting blogs.",
      };
    }
};
